...
func NewQuickstartModuleConfig(db *sql.DB, backfillImages *backfillUseCase.BackfillTenantImagesUseCase, logger pimport.PIMEventLogger) *QuickstartModuleConfig {
