...
type AttributeValueSet struct {
	...
	AttributeType          sharedEntity.AttributeType
...
func NewAttributeValueSet(attributeID, attributeName string, attributeType sharedEntity.AttributeType) *AttributeValueSet {
...
func (avs *AttributeValueSet) ValidateValue(value interface{}) error {
	...
	if avs.AttributeType == sharedEntity.AttributeTypeSelect || avs.AttributeType == sharedEntity.AttributeTypeMultiSelect {
		found := false
...
func (avs *AttributeValueSet) ValidateMultipleValues(values []string) error {
	if avs.AttributeType != sharedEntity.AttributeTypeMultiSelect {
		return errors.New("este atributo no soporta múltiples valores")
	}
