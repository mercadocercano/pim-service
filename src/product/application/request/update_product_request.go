...
// UpdateProductRequest representa la petición para actualizar un producto
type UpdateProductRequest struct {
	Name        string  `json:"name" binding:"required" example:"iPhone 15 Pro Max"`
	Description *string `json:"description,omitempty" example:"Smartphone Apple con chip A17 Pro y pantalla de 6.7 pulgadas"`
	SKU         *string `json:"sku,omitempty" example:"IPHONE-15-PRO-MAX-512GB"`
