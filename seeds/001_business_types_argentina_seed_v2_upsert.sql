...
VALUES
  ...
  ('deportes', 'Artículos Deportivos', 'Ropa deportiva, calzado deportivo, equipamiento y accesorios para deportes', 'dumbbell', '#059669', 12, true),
  ...
  ('jugueteria', 'Juguetería', 'Juguetes para todas las edades, juegos didácticos y artículos para bebés', 'gamepad-2', '#C2410C', 24, true),

  -- Mascotas
  ('veterinaria', 'Veterinaria', 'Alimentos para mascotas, productos veterinarios, accesorios y medicamentos', 'dog', '#15803D', 25, true),

  -- Servicios diversos
  ('kiosco', 'Kiosco', 'Golosinas, cigarrillos, bebidas, diarios, revistas y productos de impulso', 'newspaper', '#92400E', 26, true),
